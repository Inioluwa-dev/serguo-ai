 ...
 */
export const sendToGemini = async (message, imageData = null) => {
  try {
 ...
 * @returns {Promise<string>} - The AI response
 */
export const getContextualResponse = async (messages, newMessage, imageData = null) => {
  try {
    ...
    return await sendToGemini(fullMessage, imageData);
